...
// configuration step. It creates a namespace called `test_1`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", test_1::cmake::project_name, test_1::cmake::project_version) };
